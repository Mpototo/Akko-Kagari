...
module.exports.run = async(client, message, args, block, errorblock) => {
    ...
    .setColor(`#c542f5`)
    .addField(`**Número Total De Membros**`, `**${message.guild.memberCount}** membros`, true)
    .addField(`**Número Total De Canais**`, `**${message.guild.channels.size}** canais`, true)
    .addField(`**Número Total De Cargos**`, `**${message.guild.roles.size}** cargos`, true)
